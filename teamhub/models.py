...
class Aufgabe(models.Model):
    ...
    def getStati(self):
        ...
        if self.status==c.AUFGABE_STATUS_IP:
            '''return [c.AUFGABE_STATUS_PA, c.AUFGABE_STATUS_CL]'''
            return {AUFGABE_STATUS[2][0]:AUFGABE_STATUS[2][1],AUFGABE_STATUS[3][0]:AUFGABE_STATUS[3][1]}
        if self.status==c.AUFGABE_STATUS_PA:
            return [c.AUFGABE_STATUS_IP]
